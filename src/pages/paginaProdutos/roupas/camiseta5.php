    ...
    <main class="container">
      <div class="product-details">
        <div class="product-gallery">
          <img src="../../../assets/img/roupa/camiseta5.jpg" alt="Fone de Ouvido Bluetooth" />
        </div>
        <div class="product-info">
          <h2 class="product-name">Camiseta underground caveira</h2>
          <p class="product-code">Código do Produto: 98765XYZ</p>
          <p class="price">R$ <span>62,99</span> </p>
          <p class="rating">
      ...
      <div class="product-specs">
        ...
        <div class="specs-content">
          <div>
            <p><strong>Material:</strong> 50% Pollyester 50% Algodão</p>
          </div>
        </div>
      </div>
    </main>
