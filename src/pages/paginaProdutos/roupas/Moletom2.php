    ...
    <main class="container">
      <div class="product-details">
        <div class="product-gallery">
          <img src="../../../assets/img/roupa/Moletom2.jpg" alt="Fone de Ouvido Bluetooth" />
        </div>
        <div class="product-info">
          <h2 class="product-name">Moletom Deftones</h2>
          ...
          <p class="product-description">
            Blusão em moletom com felpa e estampa da banda Deftones. Possui capuz, modelagem regular e mangas longas, ideal para compor produções casuais. Peça confortável e versátil, confeccionado em algodão de certificado BCI.
          </p>
