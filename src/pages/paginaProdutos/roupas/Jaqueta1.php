    ...
    <main class="container">
      <div class="product-details">
        <div class="product-gallery">
          <img src="../../../assets/img/roupa/Jaqueta1.jpg" alt="Fone de Ouvido Bluetooth" />
        </div>
        <div class="product-info">
          <h2 class="product-name">Jaqueta Jeans Slipknot</h2>
      ...
      <div class="product-specs">
        ...
        <div class="specs-content">
          <div>
            <p><strong>Material Externo:</strong> Jeans e Elastano</p>
          </div>
        </div>
      </div>
    </main>
