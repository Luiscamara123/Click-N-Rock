    ...
    <main class="container">
      <div class="product-details">
        <div class="product-gallery">
          <img src="../../../assets/img/roupa/camiseta4.jpg" alt="Fone de Ouvido Bluetooth" />
        </div>
        <div class="product-info">
          <h2 class="product-name">Camiseta banda Slipknot</h2>
          <p class="product-code">Código do Produto: 98765XYZ</p>
          <p class="price">R$ <span>79,99</span></p>
          <p class="rating">
      ...
      <div class="product-specs">
        ...
        <div class="specs-content">
          <div>
            <p><strong>Material: </strong> 50% Algodão e 50% Pollyester</p>
          </div>
        </div>
      </div>
    </main>
