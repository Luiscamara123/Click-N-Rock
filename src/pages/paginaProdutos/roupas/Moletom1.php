    ...
    <main class="container">
      <div class="product-details">
        <div class="product-gallery">
          <img src="../../../assets/img/roupa/Moletom1.jpg" alt="Fone de Ouvido Bluetooth" />
        </div>
        <div class="product-info">
          <h2 class="product-name">Moletom Chorão</h2>
          ...
          <p class="product-description">
            Blusão em moletom com felpa e estampa do Chorão. Possui capuz, modelagem regular e mangas longas, ideal para compor produções casuais. Peça confortável e versátil, confeccionado em algodão de certificado BCI.
          </p>
          <div class="buttons">
            <a class="add-btn">
            Comprar
