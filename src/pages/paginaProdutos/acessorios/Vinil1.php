    ...
    <main class="container">
      <div class="product-details">
        <div class="product-gallery">
          <img src="../../../assets/img/acessorios/Vinil1.jpg" alt="Fone de Ouvido Bluetooth" />
        </div>
        <div class="product-info">
          <h2 class="product-name">Disco de Vinil ACDC</h2>
          ...
          <p class="product-description">
            Disco de vinil ACDC, os melhores sons só para você.
          </p>
          <div class="buttons">
            <a class="add-btn">
            Comprar
      ...
      <div class="product-specs">
        ...
        <div class="specs-content">
          <div>
            ...
            <p><strong>Material:</strong> Polímero plástico</p>
          </div>
        </div>
      </div>
    </main>
