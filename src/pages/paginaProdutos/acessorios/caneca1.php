    ...
    <main class="container">
      <div class="product-details">
        <div class="product-gallery">
          <img src="../../../assets/img/acessorios/caneca1.jpg" alt="Fone de Ouvido Bluetooth" />
        </div>
        <div class="product-info">
          <h2 class="product-name">Caneca Banda Metallica</h2>
          <p class="product-code">Código do Produto: 98765XYZ</p>
          <p class="price">R$ <span>59,99</span></p>
          <p class="rating">
