    ...
    <main class="container">
      <div class="product-details">
        <div class="product-gallery">
          <img src="../../../assets/img/acessorios/Colar1.jpg" alt="Fone de Ouvido Bluetooth" />
        </div>
        <div class="product-info">
          <h2 class="product-name">Colar Spike</h2>
          <p class="product-code">Código do Produto: 98765XYZ</p>
          <p class="price">R$ <span>30,99</span></p>
          <p class="rating">
          ...
          <p class="product-description">
            Colar Pulseira Spike Cone Metal Punk Rock. Pulseiras confeccionada em material sintético preto, detalhes com 14 spikes médio cromado presos por rebites. Regulagem por botão de pressão.
          </p>
      ...
      <div class="product-specs">
        ...
        <div class="specs-content">
          <div>
            <p><strong>Material :</strong> Couro Sintético e Aço Inoxidável</p>
          </div>
        </div>
      </div>
    </main>
