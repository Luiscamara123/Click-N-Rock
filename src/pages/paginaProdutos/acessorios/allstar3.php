    ...
    <main class="container">
      <div class="product-details">
        <div class="product-gallery">
          <img src="../../../assets/img/acessorios/All star3.jpg"/>
        </div>
        <div class="product-info">
          <h2 class="product-name">All Star Converse Branco</h2>
          ...
          Desde 1917, o Chuck Taylor All Star tem sido o ícone do dia a dia. Você já conhece os detalhes icônicos como o cabedal em lona de algodão, solado com padrão de diamante e a indistinguível biqueira de borracha. Finalizado com palmilha em EVA para ajudar a manter os pés confortáveis.
          </p>
          <div class="product-options">
            <label for="color">Cor:</label>            
            <div class="btn-cores">
              <a class="btn-cor btn-cor-preto" href="allstar1.html">Preto</a>
              <a class="btn-cor btn-cor-vermelho" href="allstar2.html">Vermelho</a>
              <a class="btn-cor btn-cor-branco" href="allstar3.html">Branco</a>
            </div>
