    ...
    <main class="container">
      <div class="product-details">
        <div class="product-gallery">
          <img src="../../../assets/img/acessorios/new rocks1.jpg" alt="Fone de Ouvido Bluetooth" />
        </div>
        <div class="product-info">
          <h2 class="product-name">Sapato Plataforma New Rock - Preto</h2>
          <p class="product-code">Código do Produto: 98765XYZ</p>
          <p class="price">R$ <span>699,00</span></p>
          <p class="rating">
      ...
      <div class="product-specs">
        ...
        <div class="specs-content">
          <div>
            <p><strong>Material:</strong> Couro</p>
            <p><strong>Solado:</strong> Borracha</p>
          </div>
        </div>
      </div>
    </main>
