    ...
    <main class="container">
      <div class="product-details">
        <div class="product-gallery">
          <img src="../../../assets/img/acessorios/Bracelete1.jpg" alt="Fone de Ouvido Bluetooth" />
        </div>
        <div class="product-info">
          <h2 class="product-name">Bracelete Conjunto</h2>
          <p class="product-code">Código do Produto: 98765XYZ</p>
          <p class="price">R$ <span>12,99</span></p>
          <p class="rating">
      ...
      <div class="product-specs">
        ...
        <div class="specs-content">
          <div>
            <p><strong>Material :</strong>Couro Sintético </p>
          </div>
        </div>
      </div>
    </main>
